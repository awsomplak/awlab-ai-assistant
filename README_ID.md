...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-81%20passing-brightgreen" alt="81 tes lulus" />
...
| [`docs/id/AVAILABLE_TOOLS.md`](docs/id/AVAILABLE_TOOLS.md)   | 2 tool MCP yang tersedia dan **26 action** yang ditanganinya (plan, task, memory, graph, context, util, workflow), graph, cache offline, dan multi project          |
