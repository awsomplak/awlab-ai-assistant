...
├── src/mcp_server/              # Python MCP server (single exe: action_call + action_help, 26 actions)
├── scripts/
...
3. **MCP surface is visible** — ask your agent for `action_help` to see the grouped action overview (26 actions).
